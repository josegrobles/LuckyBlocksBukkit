...
public class LuckyBlockActionController implements Listener {
    ...
    public void LuckyPit(BlockBreakEvent event){
        ...
        coinMeta.setDisplayName("§6Moneda de la victoria");
        List<String> lore = new ArrayList<String>();
        lore.add("§9Una moneda para dominarlos a todos");
        coinMeta.setLore(lore);
        coin.setItemMeta(coinMeta);
        event.getPlayer().sendMessage("§9Lanza la moneda al Pozo");
    ...
    public void coinCheck(PlayerDropItemEvent event){
            ...
            if (coinDropper.equalsIgnoreCase(event.getPlayer().getDisplayName())  && (LocationX == coinLocationX)){
                ...
                if (RandomProbability<50){
                    event.getPlayer().sendMessage("§6Esta vez has tenido suerte");
                ...
                event.getItemDrop().remove();
                 ...
                 event.getPlayer().sendMessage("Lánzala más cerca del agua");
            }
    }
    ...
    public void MagicChest(BlockBreakEvent event){
        ...
        BlockFace directionInfo = new LuckyBlockInvokeMethodClass().getCardinalDirection(event.getPlayer());
    ...
    public void UnluckyMagicChest(PlayerInteractEvent event){
        ...
        else  event.getPlayer().sendMessage("Esta vez has tenido suerte");
    }
